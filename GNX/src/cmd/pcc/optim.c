...
/*
 * optim.c: version 5.1 of 9/8/83
 * 
 */
# ifdef SCCS
static char *sccsid = "@(#)optim.c	5.1 (NSC) 9/8/83";
# endif

/* jima 6/30/82: added & then removed optdebug flag & debug code in optim() */
# include "mfile1"
