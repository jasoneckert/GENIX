/*
 * blok.c: version 1.4 of 9/9/82
 * Unix System Command Source File
 */
# ifdef SCCS
static char *sccsid = "@(#)blok.c	1.4 (NSC) 9/9/82";
# endif
...
BLKPTR		bloktop=BLK(end_image);	/*top of arena (last blok)*/
	...
	POS		reqd;
{
	...
	if (bloktop > brkend) setbrk(reqd);
	bloktop->word=BLK(ADR(end_image)+1);
	BEGIN
	...
	BLKPTR	ptr;
{
	...
	LOOP
	   ...
	   IF q<end_image ORF q>bloktop THEN abort(3) FI
