/*
 * sccshelp.c: version 1.2 of 11/6/82
 * (System III) Sccs Source
 */
# ifdef SCCS
static char *sccsid = "@(#)sccshelp.c	1.2 (NSC) 11/6/82";
# endif
...
/*
	...
	will be attempted on 'HELPDIR/cmds', with the search key
	...
	'HELPDIR/<non-numeric prefix>', (e.g, HELPDIR/zz),
	...
	'HELPDIR/default' with the search key being
	the entire argument.
...
*/
# ifndef HELPDIR
# define HELPDIR	"/usr/nsc/lib/help/"
# endif
# ifndef HELPDFLT
# define HELPDFLT	"/usr/nsc/lib/help/default"
# endif
char	dftfile[]   =   HELPDFLT;
