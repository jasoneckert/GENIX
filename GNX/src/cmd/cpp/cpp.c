/*
 * cpp.c: version 1.2 of 12/3/82
 * 
 */
# ifdef SCCS
static char *sccsid = "@(#)cpp.c	1.2 (NSC) 12/3/82";
# endif
/*JZ 9-13-82 added definition of ns16000 for use with conditional compilation
             on line 10015 */
/*JZ 9-13-82 added ns16000 to the ifdef that checks for vax or pdp11 seems to
             be for sign extension of chars */
/*JZ 12/3/82:Changed include file to macro INCLUDE that is defined in Makefile*/
#ifdef FLEXNAMES
#define	NCPS	128
#else
#define	NCPS	8
...
# if unix
	dirs[nd++] = INCLUDE;/* defined in makefile */
# if gcos
	dirs[nd++] = "cc/include";
# endif
# if ibm
