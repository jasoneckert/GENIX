/*
 * exrecover.c: version 1.5 of 9/27/83
 * 
 */
# ifdef SCCS
static char *sccsid = "@(#)exrecover.c	1.5 (NSC) 9/27/83";
# endif
 ...
 * (i.e. usually /usr/tmp) and in usrpath(preserve).
	...
	char *dir;
{
	...
	/*
	 * Search usrpath(preserve) and, if we can get there, /usr/tmp
