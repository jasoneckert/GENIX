/*
 * flsbuf.c: version 1.2 of 9/3/82
 * Mesa Unix C Library Source File
 */
# ifdef SCCS
static char *sccsid = "@(#)flsbuf.c	1.2 (NSC) 9/3/82";
# endif
...
{
	register struct _iobuf *iop;
/*	extern struct _iobuf *_lastbuf; TEMPORARY COMPILER BUG */

	for (iop = _iob; iop < &_iob[_NFILE]/*_lastbuf*/; iop++)
		fclose(iop);
}
