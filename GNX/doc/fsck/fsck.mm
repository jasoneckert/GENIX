...
system, incorrect directory inode numbers for ``\f1.\fP'' and ``\f1..\fP'',
...
.P
The directory inode number entry for ``\f1.\fP''
...
.DS 0 1
.Hu "\f3C\fP option?"
\f3C\fP is not a legal option to
.I fsck ;
...
.DE
.DS 0 1
.Hu "Can't open checklist file: \f3F\fP"
...
.DE
.DS 0 1
.Hu "Can't stat \f3F\fP"
.I Fsck 's
request for statistics about the file system \f3F\fP failed.
It ignores this file system
and continues checking the next file system given.
Check access modes of \f3F\fP.
.DE
.DS 0 1
.Hu "\f3F\fP is not a block or character device"
You have given
.I fsck\^
a regular file name by mistake.
It ignores this file system and continues checking the next file system given.
Check file type of \f3F\fP.
.DE
.DS 0 1
.Hu "Can't open \f3F\fP"
The file system \f3F\fP can not be opened for reading.
It ignores this file system and continues checking the next file system given.
Check access modes of \f3F\fP.
.DE
.DS 0 1
.Hu "Size check: fsize \f3X\fP isize \f3Y\fP"
More blocks are used for the inode list \f3Y\fP than there are blocks in the
file system \f3X\fP, or
there are more than 65,535 inodes in the file system.
It ignores this file system and continues checking the next file system given.
See Section 4.1.1.
.DE
.DS 0 1
.Hu "Can't create \f3F\fP"
.I Fsck 's
request to create a scratch file \f3F\fP failed.
It ignores this file system and continues checking the next file system given.
Check access modes of \f3F\fP.
.DE
.DS 0 1
.Hu "CAN NOT SEEK: BLK \f3B\fP (CONTINUE)"
.I Fsck 's
request for moving to a specified block number \f3B\fP in
...
.DE
.DS 0 1
.Hu "CAN NOT READ: BLK \f3B\fP (CONTINUE)"
.I Fsck 's
request for reading a specified block number \f3B\fP in
the file system failed.
This should never happen.
See a guru.
.P
...
.DE
.DS 0 1
.Hu "CAN NOT WRITE: BLK \f3B\fP (CONTINUE)"
.I Fsck 's
request for writing a specified block number \f3B\fP
in
the file system failed.
...
.DS 0 1
.Hu "UNKNOWN FILE TYPE I=\f3I\fP (CLEAR)"
The mode word of the inode \f3I\fP indicates that the inode is not a
...
.VL 10 2 1
.LI YES
de-allocate inode \f3I\fP by zeroing its contents.
...
.DE
.DS 0 1
.Hu "\f3B\fP BAD I=\f3I\fP"
Inode \f3I\fP contains block number \f3B\fP with a number
...
inode \f3I\fP has too many block numbers outside the file system range.
This error condition will always invoke the BAD/DUP error condition in Phase 2 and Phase 4.
See Section 4.2.4.
.DE
.DS 0 1
.Hu "EXCESSIVE BAD BLKS I=\f3I\fP (CONTINUE)"
...
the number of last block in the file system associated with inode \f3I\fP.
See Section 4.2.4.
.P
Possible responses to the CONTINUE prompt are:
.VL 10 2 1
...
.DE
.DS 0 1
.Hu "\f3B\fP DUP I=\f3I\fP"
Inode \f3I\fP contains block number \f3B\fP which is already claimed by
another inode.
This error condition may invoke the EXCESSIVE DUP BLKS error condition in Phase 1 if
inode \f3I\fP has too many block numbers claimed by other inodes.
This error condition will always invoke Phase 1b and
the BAD/DUP error condition in Phase 2 and Phase 4.
See Section 4.2.3.
.DE
.DS 0 1
.Hu "EXCESSIVE DUP BLKS I=\f3I\fP (CONTINUE)"
...
.DE
.DS 0 1
.Hu "POSSIBLE FILE SIZE ERROR I=\f3I\fP"
The inode \f3I\fP size does not match the actual number of blocks
used by the inode.
This is only a warning.
See Section 4.2.5.
.DE
.DS 0 1
.Hu "DIRECTORY MISALIGNED I=\f3I\fP"
...
.DE
.DS 0 1
.Hu "PARTIALLY ALLOCATED INODE I=\f3I\fP (CLEAR)"
Inode \f3I\fP is neither allocated nor unallocated.
See Section 4.2.1.
.P
Possible responses to the CLEAR prompt are:
.VL 10 2 1
...
.DS 0 1
.Hu "\f3B\fP DUP I=\f3I\fP"
Inode \f3I\fP contains block number \f3B\fP which is already claimed by another
inode.
...
.DE
.DS 0 1
.Hu "I OUT OF RANGE I=\f3I\fP NAME=\f3F\fP (REMOVE)"
A directory entry \f3F\fP has an inode number \f3I\fP which is greater than
...
.VL 10 2 1
.LI YES
the directory entry \f3F\fP is removed.
.LI NO
ignore this error condition.
.LE
.DE
.DS 0 1
.Hu "UNALLOCATED I=\f3I\fP OWNER=\f3O\fP MODE=\f3M\fP SIZE=\f3S\fP MTIME=\f3T\fP NAME=\f3F\fP (REMOVE)"
A directory entry \f3F\fP has an inode \f3I\fP
without allocate mode bits.
The owner \f3O\fP, mode \f3M\fP, size \f3S\fP, modify time \f3T\fP, and file name \f3F\fP are printed.
See Section 4.4.
.P
Possible responses to the REMOVE prompt are:
.VL 10 2 1
...
.DE
.DS 0 1
.Hu "DUP/BAD I=\f3I\fP OWNER=\f3O\fP MODE=\f3M\fP SIZE=\f3S\fP MTIME=\f3T\fP DIR=\f3F\fP (REMOVE)"
Phase 1 or Phase 1b have found duplicate blocks or bad blocks
associated with directory entry \f3F\fP, directory inode \f3I\fP.
The owner \f3O\fP, mode \f3M\fP, size \f3S\fP, modify time \f3T\fP, and directory name \f3F\fP are printed.
See Section 4.2.3 and 4.2.4.
.P
Possible responses to the REMOVE prompt are:
.VL 10 2 1
...
.DE
.DS 0 1
.Hu "DUP/BAD I=\f3I\fP OWNER=\f3O\fP MODE=\f3M\fP SIZE=\f3S\fP MTIME=\f3T\fP FILE=\f3F\fP (REMOVE)"
Phase 1 or Phase 1b have found duplicate blocks or bad blocks
associated with directory entry \f3F\fP, inode \f3I\fP.
The owner \f3O\fP, mode \f3M\fP, size \f3S\fP, modify time \f3T\fP, and file name \f3F\fP are printed.
See Section 4.2.3 and 4.2.4.
.P
Possible responses to the REMOVE prompt are:
...
directories.
.DS 0 1
.Hu "UNREF DIR I=\f3I\fP OWNER=\f3O\fP MODE=\f3M\fP SIZE=\f3S\fP MTIME=\f3T\fP (RECONNECT)"
The directory inode \f3I\fP was not connected to a directory entry
when the file system was traversed.
The owner \f3O\fP, mode \f3M\fP, size \f3S\fP, and modify time \f3T\fP of directory
inode \f3I\fP are printed.
See Section 4.4 and 4.2.2.
.P
Possible responses to the RECONNECT prompt are:
.VL 10 2 1
.LI YES
reconnect directory inode \f3I\fP to the file system in the
directory for lost files (usually
.I lost+found ).
This may invoke the
.I lost+found\^
error condition in Phase 3
if there are problems connecting directory inode \f3I\fP
to
.I lost+found .
...
.DE
.DS 0 1
.Hu "DIR I=\f3I1\fP CONNECTED. PARENT WAS I=\f3I2\fP"
This is an advisory message indicating a directory inode \f3I1\fP was
successfully connected to the
.I lost+found\^
directory.
The parent inode \f3I2\fP of the directory inode \f3I1\fP is
...
.DS 0 1
.Hu "UNREF FILE I=\f3I\fP OWNER=\f3O\fP MODE=\f3M\fP SIZE=\f3S\fP MTIME=\f3T\fP (RECONNECT)"
Inode \f3I\fP was not connected to a directory entry
when the file system was traversed.
The owner \f3O\fP, mode \f3M\fP, size \f3S\fP, and
modify time \f3T\fP of inode \f3I\fP are printed.
See Section 4.2.2.
.P
Possible responses to the RECONNECT prompt are:
.VL 10 2 1
.LI YES
reconnect inode \f3I\fP to the file system in the directory for
lost files (usually
.I lost+found ).
This may invoke
the
...
if there are problems connecting inode \f3I\fP to
.I lost+found .
.LI NO
...
.DE
.DS 0 1
.Hu "LINK COUNT FILE I=\f3I\fP OWNER=\f3O\fP MODE=\f3M\fP SIZE=\f3S\fP MTIME=\f3T\fP COUNT=\f3X\fP SHOULD BE \f3Y\fP (ADJUST)"
The link count for inode \f3I\fP which is a file, is \f3X\fP but should be \f3Y\fP.
The owner \f3O\fP, mode \f3M\fP, size \f3S\fP, and modify time \f3T\fP
are printed.
See Section 4.2.2.
.P
...
.VL 10 2 1
.LI YES
replace the link count of file inode \f3I\fP with \f3Y\fP.
.LI NO
ignore this error condition.
.LE
.DE
.DS 0 1
.Hu "LINK COUNT DIR I=\f3I\fP OWNER=\f3O\fP MODE=\f3M\fP SIZE=\f3S\fP MTIME=\f3T\fP COUNT=\f3X\fP SHOULD BE \f3Y\fP (ADJUST)"
The link count for inode \f3I\fP which is a directory, is \f3X\fP but should be \f3Y\fP.
The owner \f3O\fP, mode \f3M\fP, size \f3S\fP, and modify time \f3T\fP
of directory inode \f3I\fP are printed.
See Section 4.2.2.
.P
Possible responses to the ADJUST prompt are:
.VL 10 2 1
.LI YES
replace the link count of directory inode \f3I\fP with \f3Y\fP.
.LI NO
ignore this error condition.
.LE
.DE
.DS 0 1
.Hu "LINK COUNT \f3F\fP I=\f3I\fP OWNER=\f3O\fP MODE=\f3M\fP SIZE=\f3S\fP MTIME=\f3T\fP COUNT=\f3X\fP SHOULD BE \f3Y\fP (ADJUST)"
The link count for \f3F\fP inode \f3I\fP is \f3X\fP but should be \f3Y\fP.
The name \f3F\fP,
owner \f3O\fP, mode \f3M\fP, size \f3S\fP, and modify time
\f3T\fP
are printed.
See Section 4.2.2.
.P
...
.VL 10 2 1
.LI YES
replace the link count of inode \f3I\fP with \f3Y\fP.
.LI NO
ignore this error condition.
.LE
.DE
.DS 0 1
.Hu "UNREF FILE I=\f3I\fP OWNER=\f3O\fP MODE=\f3M\fP SIZE=\f3S\fP MTIME=\f3T\fP (CLEAR)"
Inode \f3I\fP which is a file, was not connected to a directory entry when the
file system was traversed.
The owner \f3O\fP, mode \f3M\fP, size \f3S\fP, and modify time \f3T\fP of inode \f3I\fP
are printed.
...
.DE
.DS 0 1
.Hu "UNREF DIR I=\f3I\fP OWNER=\f3O\fP MODE=\f3M\fP SIZE=\f3S\fP MTIME=\f3T\fP (CLEAR)"
Inode \f3I\fP which is a directory, was not connected to a directory entry when the
file system was traversed.
The owner \f3O\fP, mode \f3M\fP, size \f3S\fP, and modify time \f3T\fP of inode \f3I\fP
are printed.
See Section 4.2.2 and 4.4.
...
.DE
.DS 0 1
.Hu "BAD/DUP FILE I=\f3I\fP OWNER=\f3O\fP MODE=\f3M\fP SIZE=\f3S\fP MTIME=\f3T\fP (CLEAR)"
...
.DE
.DS 0 1
.Hu "BAD/DUP DIR I=\f3I\fP OWNER=\f3O\fP MODE=\f3M\fP SIZE=\f3S\fP MTIME=\f3T\fP (CLEAR)"
Phase 1 or Phase 1b have found duplicate blocks or
bad blocks associated with directory inode \f3I\fP.
The owner \f3O\fP, mode \f3M\fP, size \f3S\fP, and modify time \f3T\fP of inode \f3I\fP
are printed.
See Section 4.2.3 and 4.2.4.
.P
...
.DE
.DS 0 1
.Hu "\f3X\fP BAD BLKS IN FREE LIST"
\f3X\fP blocks
...
.DE
.DS 0 1
.Hu "\f3X\fP DUP BLKS IN FREE LIST"
\f3X\fP blocks
...
.DS 0 1
.Hu "\f3X\fP files \f3Y\fP blocks \f3Z\fP free"
This is an advisory message indicating that
the file system checked contained
\f3X\fP files using
\f3Y\fP blocks leaving
\f3Z\fP blocks free in the file system.
.DE
.DS 0 1
